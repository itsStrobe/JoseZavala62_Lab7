...
function getAllBookmarks(){
    let req_url = `http://localhost:${PORT}/bookmarks-api/bookmarks`;
    let settings = {
        method : 'GET',
        headers : {
...
function getBookmarksByTitle(title){
    let req_url = `http://localhost:${PORT}/bookmarks-api/bookmark?title=${title}`;
...
function addBookmark(title, description, url, rating){
    let req_url = `http://localhost:${PORT}/bookmarks-api/bookmark`;
...
function deleteBookmarkById(id){
    let req_url = `http://localhost:${PORT}/bookmarks-api/bookmark/${id}`;
